...
- **Base de datos:** MySQL / PostgreSQL (dependiendo de tu implementación)  
- **Gestión de dependencias:** JDBC  

---

## 📷 Capturas de pantalla

> *(Aquí puedes añadir imágenes de tu aplicación, como el menú principal, formularios y tablas con datos)*  

Ejemplo:

![Menú Principal](docs/menu-principal.png)  
![Gestión de Vehículos](docs/gestion-vehiculos.png)
